...
class AdminMiddleware
{
    ...
    */
    ...
    # IMPORTANT NOTE: The handle() method handles the incoming request and interact with the current HTTP request being handled by our application as well as retrieve the input, cookies, and files that were submitted by the request.
