                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <?php else: ?>
                            ...
                            <li class="nav-item" title="Create Post">
                                <a href="<?php echo e(route('post.create')); ?>" class="nav-link"><i class="fa-solid fa-circle-plus icon-sm"></i></a>
                            </li>
...
<?php /**PATH C:\Users\Ribbonne\Desktop\laravel-insta\insta-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>