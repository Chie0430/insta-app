        ...
        <div class="row mb-3">
            <div class="col-auto">
                <a href="<?php echo e(route('profile.show', $user->id)); ?>" class="text-decoration-none text-dark">
                    <strong><?php echo e($user->posts->count()); ?></strong>
                    <?php echo e($user->posts->count() == 1 ? 'Post':'Posts'); ?>

                </a>
            </div>
            <div class="col-auto">
                <a href="<?php echo e(route('profile.followers', $user->id)); ?>" class="text-decoration-none text-dark">
                    <strong><?php echo e($user->followers->count()); ?></strong>
                    <?php echo e($user->followers->count() == 1 ? 'Follower':'Followers'); ?>

                </a>
            </div>
            <div class="col-auto">
                <a href="<?php echo e(route('profile.following', $user->id)); ?>" class="text-decoration-none text-dark">
                    <strong><?php echo e($user->following->count()); ?></strong>
                    Following
                </a>
            </div>
        </div>
...
</div><?php /**PATH C:\Users\Ribbonne\Desktop\laravel-insta\insta-app\resources\views/users/profile/header.blade.php ENDPATH**/ ?>