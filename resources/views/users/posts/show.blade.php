            ...
            <div class="card border-0">
                <div class="card-header bg-white py-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            {{-- If the Auth user is the owner of the post, then the user can edit and delete the post. --}}
                            ...
                            @else
                                {{-- If the user is not the owner pof the post, then display the Follow/Unfollow button only --}}
                ...
                <div class="card-body w-100">
                    ...
                    {{-- M - Month(upper), d - day(lower), Y - Year(upper) --}}
                    {{-- strtotime(date&time) --}}
